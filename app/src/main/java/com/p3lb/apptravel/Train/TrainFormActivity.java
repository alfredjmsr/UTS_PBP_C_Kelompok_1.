...
public class TrainFormActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_form_train);
        ...
        id_flight = mIntent.getStringExtra("id_train");
        from_flight = mIntent.getStringExtra("from_train");
        to_flight = mIntent.getStringExtra("to_train");
        fromtime_flight = mIntent.getStringExtra("fromtime_train");
        totime_flight = mIntent.getStringExtra("totime_train");
        class_flight = mIntent.getStringExtra("class_train");
        price_flight = mIntent.getStringExtra("price_train");
        name_flight = mIntent.getStringExtra("name_train");
        txtTitle.setText(name_flight+" "+"("+from_flight+"->"+to_flight+")");
        btnBack.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(TrainFormActivity.this, TrainActivity.class);
        ...
        btnConfirm.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (txtFirstname.getText().toString().isEmpty() ||
                    ...
                    Toasty.warning(TrainFormActivity.this, "Isi data dengan lengkap!", Toast.LENGTH_SHORT).show();
                } else {
                    buyTicket();
                }
            }
    ...
    void buyTicket(){
        ...
        Call<Order> orderCall = mApiInterface.buyTrainTicket(
